...
sim.df_gg <- sim.df %>%
  ...
  dplyr::select(1,2,3,4,13,14,15,16) %>%
  gather(method, prob, c(5:8)) %>%
...
sim.df$meanerrorHardCutTF_num <- sim.df$meanerrorHardCutTP_num - sim.df$meanerrorHardCutFP_num
sim.df$meanerrorPropReadTF_num <- sim.df$meanerrorPropReadTP_num - sim.df$meanerrorPropReadFP_num
sim.df$meanerrorPropRepsTF_num <- sim.df$meanerrorPropRepsTP_num - sim.df$meanerrorPropRepsFP_num
sim.df$meanerrorPropReadRepsTF_num <- sim.df$meanerrorPropReadRepsTP_num - sim.df$meanerrorPropReadRepsFP_num
...
gridExtra::grid.arrange(tp_plot, fp_plot, nrow = 2)

g <- gridExtra::arrangeGrob(tp_plot, fp_plot, nrow=2) #generates g
